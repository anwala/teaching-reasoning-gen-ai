...
# W&M DATA 101-02 - Reasoning with Generative AI, Spring 2026 Syllabus
...
Every minute each day, about 16,000 TikToks are uploaded, 3.4 million videos watched on YouTube, 5.9 million Google searches, 1.8 million ChatGPT prompts, and 18.8 million sent text messages. We generate tons of data which can be mined to gain valuable information about our health, economic, or social condition. In this course, students will learn the fundamentals of data, including, how data it can be represented and visualized, and how to process it to derive meaningful results with computer programs designed with and without generative AI (specifically, large language models, or LLMs).

Throughout the course an emphasis will be placed on important pillars of problem-solving including, problem decomposition, abstraction, modular logically planned problem solving approaches, and critical evaluation of code and results, whether AI or human-generated. Moreover students would learn and be encouraged to effectively communicate both intentions and results visually and in writing. No prior programming experience is required and all mathematical concepts will be built from the ground up. This course is suitable for individuals from any major who want to develop modern computing skills applicable across a variety of disciplines.

Upon successfully completing the course, students will be well equipped to with fundamental knowledge needed to begin more in-depth studies and problem-solving of Data Science problems.

## Course Venue and Time

Integrated Science Center, room 1280. Mondays/Wednesdays/Fridays 8am -– 8:50 am
...
I will post all assignments on our [DATA 101-02 course website](https://github.com/anwala/teaching-reasoning-gen-ai/blob/main/fall-2026/README.md). Your grade in this class will be based on the following components:
...
* Withdrawal deadline: March 23, 2026
